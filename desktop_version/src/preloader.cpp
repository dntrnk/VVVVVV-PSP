...
static g2dColor pre_darkcol = G2D_RGBA(0, 0, 0, 0);
static g2dColor pre_lightcol = G2D_RGBA(0, 0, 0, 0);
...
void preloaderrender(void)
{
  ...
  if(pre_transition>=30){
    switch(pre_curcol) {
    case 0:
      pre_lightcol = G2D_RGB(0xBF,0x59,0x6F);
      pre_darkcol = G2D_RGB(0x88,0x3E,0x53);
      break;
    case 1:
      pre_lightcol = G2D_RGB(0x6C,0xBC,0x5C);
      pre_darkcol = G2D_RGB(0x50,0x86,0x40);
      break;
    case 2:
      pre_lightcol = G2D_RGB(0x5D,0x57,0xAA);
      pre_darkcol = G2D_RGB(0x2F,0x2F,0x6C);
      break;
    case 3:
      pre_lightcol = G2D_RGB(0xB7,0xBA,0x5E);
      pre_darkcol = G2D_RGB(0x84,0x83,0x42);
      break;
    case 4:
      pre_lightcol = G2D_RGB(0x57,0x90,0xAA);
      pre_darkcol = G2D_RGB(0x2F,0x5B,0x6C);
      break;
    case 5:
      pre_lightcol = G2D_RGB(0x90,0x61,0xB1);
      pre_darkcol = G2D_RGB(0x58,0x3D,0x71);
      break;
    default:
      pre_lightcol = G2D_RGB(0x00,0x00,0x00);
      pre_darkcol = G2D_RGB(0x08,0x00,0x00);
      break;
    }
    ...
    graphics.fill_rect(pre_frontrectx, pre_frontrecty, pre_frontrectw,pre_frontrecth, G2D_RGB(0x3E,0x31,0xA2));
