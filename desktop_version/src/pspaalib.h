...
////////////////////////////////////////////////
//		Load an audio file from memory and prepare it for playing.
//		
//		data:The buffer containing the audio file data.
//		dataSize:Size of the buffer in bytes.
//		channel:One of PSPAALIB_CHANNEL_*.The channel
//				onto which the file is opened.
//		loadToRam:Whether to copy the data into a separate buffer.
//		
//		Returns 0 on success,>0 on error.
////////////////////////////////////////////////

int AalibLoadFromMemory(const unsigned char *data, int dataSize, int channel, bool loadToRam);
